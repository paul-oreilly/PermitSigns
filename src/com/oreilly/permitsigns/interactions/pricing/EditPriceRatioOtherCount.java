...
public class EditPriceRatioOtherCount extends TitledInteractionPage {
	
	public EditPriceRatioOtherCount() {
		super();
		defaultTitle = "Edit Ratio (Other Count)";
	...
	public String acceptValidatedInput( Interaction interaction, Object data ) throws ContextDataRequired,
		...
		RatioDataRetriever helper = new RatioDataRetriever( interaction );
		helper.currentRatio.otherCount = value;
